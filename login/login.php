...
<body class="bg-[#181f2a] min-h-screen flex items-center justify-center p-6">
    ...
    <div
        class="max-w-md w-full glass rounded-2xl shadow-2xl transform transition-all duration-500 hover:scale-[1.02] floating z-10">
        ...
        <div class="p-8">
            ...
            <form class="space-y-6" method="post">
                ...
                <button name="submit" type="submit" class="w-full bg-teal-600 text-white py-3 rounded-xl font-medium
            ...
            <div class="mt-6 text-center text-gray-600">
                Belum punya akun?
                <a href="register.php"
                    class="text-teal-600 hover:text-teal-800 transition-colors duration-300 font-medium hover:underline">
                    Daftar sekarang
                </a>
            </div>
        </div>
