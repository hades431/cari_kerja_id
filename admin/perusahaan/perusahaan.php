        ...
        <div class="flex-1 flex flex-col bg-white min-h-screen ml-64">
            ...
            <div class="p-8 grid grid-cols-1 md:grid-cols-3 gap-6">
                <a href="acc.php" class="block">
                    <div
                        class="bg-gradient-to-br from-green-500 to-green-700 rounded-2xl shadow-lg p-8 text-white border-2 border-transparent hover:border-white/40 transform hover:-translate-y-1 active:scale-95 transition duration-200 text-center">
                ...
                <a href="menunggu.php" class="block">
                    <div
                        class="bg-gradient-to-br from-yellow-400 to-yellow-600 rounded-2xl shadow-lg p-8 text-white border-2 border-transparent hover:border-white/40 transform hover:-translate-y-1 active:scale-95 transition duration-200 text-center">
                ...
                <a href="ditolak.php" class="block">
                    <div
                        class="bg-gradient-to-br from-red-400 to-red-600 rounded-2xl shadow-lg p-8 text-white border-2 border-transparent hover:border-white/40 transform hover:-translate-y-1 active:scale-95 transition duration-200 text-center">
