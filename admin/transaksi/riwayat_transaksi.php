    ...
    <div class="flex min-h-screen">
        <aside class="bg-gradient-to-b from-teal-700 to-teal-900 w-64 flex flex-col shadow-xl fixed inset-y-0 left-0">
          ...
          <?= $menuAktif['artikel'] ? 'bg-teal-900 text-white' : 'text-teal-100 hover:bg-teal-900 hover:text-white' ?>">
                ...
                <a href="../../public/logout.php" onclick="return confirm('Yakin mau logout?')"
                    class="flex items-center gap-3 px-6 py-3 rounded-lg font-medium transition 
            ...
            <div class="p-8">
                ...
                <div class="flex items-center justify-between mb-4">
                    <form method="GET" class="flex gap-2 w-1/3">
                        <input type="text" name="search" placeholder="Cari perusahaan..."
                            value="<?= htmlspecialchars($keyword) ?>" class="px-4 py-2 w-full rounded-lg border border-gray-300 
                ...
                <div class="bg-gradient-to-r from-teal-700 to-teal-500 rounded-t-2xl overflow-hidden">
                    <table class="min-w-full text-left">
                        ...
                        <tbody class="bg-white rounded-b-2xl">
                            ...
                            <tr class="border-b">
                                ...
                                <td class="py-3 px-4">
                                    ...
                                    <a href="/cari_kerja_id/admin/perusahaan/bukti_pembayaran.php?id=<?= $t['id_perusahaan'] ?>"
                                ...
                                <td class="py-3 px-4">
                                    ...
                                    <span
                                        class="inline-block bg-green-600 text-white px-5 py-2 rounded-lg font-semibold">Sudah</span>
                                    <?php else: ?>
                                    <span
                                        class="inline-block bg-red-600 text-white px-5 py-2 rounded-lg font-semibold">Belum</span>
                                    <?php endif; ?>
                                </td>
                        ...
                        ?>
                                    <a href="perpanjang.php"
                                        class="bg-yellow-500 hover:bg-yellow-600 text-white px-4 py-2 rounded-lg font-semibold transition inline-block text-center">Perpanjang</a>
                                    <?php } else { ?>
                                    <span
                                        class="bg-gray-300 text-gray-500 px-4 py-2 rounded-lg font-semibold inline-block text-center cursor-not-allowed opacity-60">Perpanjang</span>
                                    <?php } ?>
                                </td>
                            </tr>
                            <?php endforeach; ?>
