    ...
    <div class="flex min-h-screen">
        ...
        <div class="flex-1 flex flex-col bg-white min-h-screen ml-64">
            ...
            <main class="p-8 flex-1 space-y-10">
                ...
                <div class="bg-white shadow rounded-2xl p-5">
                    ...
                    <div class="space-y-3">
                        ...
                        <div class="p-4 bg-gray-50 rounded-xl shadow-sm text-sm text-gray-700">
                            <?= htmlspecialchars(($a['icon'] ?? '') . ' ' . ($a['pesan'] ?? '')) ?>
                            <?php if (!empty($a['tanggal'])): ?>
                            - <span class="text-xs text-gray-400"><?= date("d/m/Y", strtotime($a['tanggal'])) ?></span>
                            <?php endif; ?>
                        </div>
                        <?php endforeach; ?>
                        <?php else: ?>
                        <div class="p-4 bg-gray-50 rounded-xl shadow-sm text-sm text-gray-500">Tidak ada aktivitas.
                        </div>
                        <?php endif; ?>
                    </div>
                </div>
                ...
                <div class="bg-white shadow rounded-2xl p-5">
                    ...
                    <div class="space-y-3">
                        ...
                        <div
                            ...
                            <span><?= htmlspecialchars(($n['icon'] ?? '') . ' ' . ($n['pesan'] ?? '')) ?></span>
                            <?php if (!empty($n['link']) && !empty($n['aksi'])): ?>
                            <a href="<?= htmlspecialchars($n['link']) ?>"
                                class="text-xs text-blue-600 hover:underline"><?= htmlspecialchars($n['aksi']) ?></a>
                            <?php endif; ?>
                        </div>
                        <?php endforeach; ?>
                        <?php else: ?>
                ...
                <div class="bg-white shadow rounded-2xl p-5">
                    <h2 class="font-semibold text-lg mb-3">Lowongan Hari Ini</h2>
                    <div class="space-y-3">
                        <?php
                ...
                <div class="bg-white shadow rounded-2xl p-5">
                    ...
                    <div class="space-y-3">
                        ...
                        <div
                            class="p-4 bg-gray-50 rounded-xl shadow-sm flex justify-between items-center text-sm text-gray-700">
                            <span>📄 <a href="../../admin/tips_kerja/lihat_artikel.php?id=<?= (int)$art['id'] ?>"
                                    class="text-blue-600 hover:underline"><?= htmlspecialchars($art['judul']) ?></a></span>
                            <span
