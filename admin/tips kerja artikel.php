        ...
        <main class="flex-1 flex flex-col bg-white">
            ...
            <div class="flex-1 p-8 bg-gray-100">
                <div class="flex items-center gap-4 mb-4">
                    <a class="bg-gray-400 text-white px-6 py-2 rounded-full font-semibold text-lg shadow" type="button"
                        href="../admin/tambah artikel.php">+ Tambah Artikel</a>
                    <input type="text" class="bg-white border rounded px-4 py-2 w-64" placeholder="Cari artikel...">
                    <button class="bg-gray-200 px-3 py-2 rounded"><svg xmlns="http://www.w3.org/2000/svg"
                    ...
                    <button class="bg-gray-200 px-3 py-2 rounded"><svg xmlns="http://www.w3.org/2000/svg"
                            class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            <path d="M3 6h18M6 10h12M9 14h6" stroke="currentColor" stroke-width="2"
                                stroke-linecap="round" />
                        </svg></button>
                </div>
