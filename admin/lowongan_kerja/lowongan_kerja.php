            ...
            <div class="p-6 mt-6">
                ...
                <form method="GET" class="mb-4 flex gap-2">
                    <input type="text" name="search" placeholder="Cari perusahaan..."
                        value="<?= htmlspecialchars($keyword) ?>" class="px-4 py-2 w-1/3 rounded-lg border border-gray-300 
                    ...
                    <table class="min-w-full">
                        ...
                        <tbody>
                          ...
                          if (!empty($row['id_lowongan'])) {
                              ...
                              if ($stmtUploader) {
                                  $stmtUploader->bind_param('i', $row['id_lowongan']);
                                  $stmtUploader->execute();
                                  $resUploader = $stmtUploader->get_result();
                                  if ($resUploader && $resUploader->num_rows > 0) {
                                      $rU = $resUploader->fetch_assoc();
                                      $companyEmail = $rU['email'] ?? '';
                                  }
                              }
                          }
