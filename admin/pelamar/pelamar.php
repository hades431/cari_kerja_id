                    ...
                    <table class="w-full text-left border-collapse">
                        ...
                        <tbody class="divide-y divide-gray-200">
                            ...
                            <tr class="hover:bg-gray-50 transition">
                                ...
                                <td class="px-4 py-3 font-medium text-gray-700"><?= htmlspecialchars($row['role']); ?>
                                </td>
                                <td class="px-4 py-3 text-gray-600"><?= htmlspecialchars($row['email']); ?></td>
                                <td class="px-4 py-3">
                                    <span
                                        class="px-2 py-1 rounded-full text-xs font-semibold <?= $row['status_akun'] == 'aktif' ? 'bg-green-100 text-green-700' : 'bg-red-100 text-red-700' ?>">
                                        <?= $row['status_akun']; ?>
                                    </span>
                                </td>
                            ...
                            <?php else: ?>
                            <tr>
                                <td colspan="6" class="px-4 py-6 text-center text-gray-500 italic">Belum ada user
                                    terdaftar.</td>
                            </tr>
                            <?php endif; ?>
                        </tbody>
