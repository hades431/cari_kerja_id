...
<section class="bg-[#e6eef5] py-8 px-4 relative overflow-visible">
    <div class="max-w-7xl mx-auto flex flex-col items-center">
        ...
        <body class="bg-gray-200 flex justify-center items-center min-h-screen p-4">
            <div class="bg-teal-800 rounded-xl border-4 w-full max-w-md p-4 flex flex-col space-y-6">

                <!-- Search bar -->
                <div>
                    <input type="text" placeholder="Search..."
                        class="w-full rounded-lg p-2 text-gray-700 focus:outline-none focus:ring-2 focus:ring-blue-400" />
                </div>
                ...
                <div class="flex justify-center space-x-3 pt-2">
                    <div class="bg-gray-300 w-8 h-8 rounded-sm"></div>
                    <div class="bg-gray-300 w-8 h-8 rounded-sm"></div>
                    <div class="bg-gray-300 w-8 h-8 rounded-sm"></div>
                    <div class="bg-gray-300 w-8 h-8 rounded-sm"></div>
                    <div class="bg-gray-300 w-8 h-8 rounded-sm"></div>
