        ...
        <div class="max-w-7xl mx-auto flex flex-col items-center">
            ...
            <div
                ...
                <form class="w-full flex flex-col gap-8">
                    ...
                    <div class="flex flex-col md:flex-row gap-8 w-full justify-center items-center">
                        <button type="button"
                            class="bg-white rounded-full px-6 py-2 text-gray-700 text-sm font-normal focus:bg-gray-200 transition">Tanpa
                            pengalaman</button>
                        <button type="button"
                            class="bg-white rounded-full px-6 py-2 text-gray-700 text-sm font-normal focus:bg-gray-200 transition">1-5
                            Tahun</button>
                        <button type="button"
                            class="bg-white rounded-full px-6 py-2 text-gray-700 text-sm font-normal focus:bg-gray-200 transition">5
                            Tahun Lebih</button>
            ...
            <div class="bg-white rounded-3xl shadow-lg p-8 max-w-2xl w-full mt-[-40px] z-20 relative">
                <div class="text-lg text-gray-800 leading-relaxed">
                    <span class="font-semibold">LokerBandung.id</span> adalah sebuah portal informasi <a href="#"
                        class="text-[#00646A] underline">lowongan kerja Bandung</a>.<br>
                    Kami menghadirkan informasi pekerjaan terbaru setiap hari kepada masyarakat Bandung Raya ataupun
                    sekitar provinsi Jawa Barat. Sebagai kota metropolitan terbesar nomor 3 di Indonesia yang terdiri
                    atas wilayah kota Bandung, kabupaten Bandung, kabupaten Bandung Barat, kota
                </div>
            </div>
        </div>
    </section>
